				...
				<?php 
					if(isset($_POST['adduser'])){
						...
						if($numrows > 0){
							...
							$datainsert="INSERT INTO `user`(`first_name`, `last_name`, `username`, `password`, `role` , `useremail`) VALUES ('$fname','$lname','$username','$haspassword','$role','$email')";
